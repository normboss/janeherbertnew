...
<head>
    ...
    <link type="text/css" href="../css/cubeX.css" rel="stylesheet" />
</head>

<body>
    <div class="description">
        Textured Cube with a different image on each face using a texture altas. <br />
    </div>
...
<script id="3d-vertex-shader" type="x-shader/x-vertex">
    ...
    void main() {
        gl_Position = u_matrix * a_position;    // Multiply the position by the matrix.
