...
<body>
    ...
    <div class="artwork-container">
        <div class="artwork">
            <img src="../images/morse_mountain_view.jpg" usemap="#map" style="width:100%">
            <!-- 600 x 468 -->

            <map name="map">
                <area shape="rect" coords="502,0,1004,681" alt="" href="../pages/<?php echo $page->next ?>" title="Click image for Next">
                <area shape="rect" coords="0,0,501,681" alt="" href="../pages/<?php echo $page->prev ?>" title="Click image for Previous">
            </map>
