...
<body>
    ...
    <div class="slideshow-container">
        ...
        <div class="my-slides fade">
            ...
            <img src="../images/low_pressure_appleton_ridge72px.jpg" style="width:100%">
        </div>

        <div class="my-slides fade">
            <div class="numbertext">2 / 10</div>
            <img src="../images/side_light_herbert.jpg" style="width:100%">
        </div>

        <div class="my-slides fade">
            <div class="numbertext">3 / 10</div>
            <img src="../images/vespers_herbert2.jpg" style="width:100%">
        </div>

        <div class="my-slides fade">
            <div class="numbertext">4 / 10</div>
            <img src="../images/eagle_nubbins_72.jpg" style="width:100%">
        </div>

        <div class="my-slides fade">
            <div class="numbertext">5 / 10</div>
            <img src="../images/ubiquity.jpg" style="width:100%">
        </div>
        ...
        <div class="my-slides fade">
            ...
            <img src="../images/jane_herbert_nubbins.jpg" style="width:100%">
        </div>

        <div class="my-slides fade">
            <div class="numbertext">8 / 10</div>
            <img src="../images/on_lookout_rock_herbert.jpg" style="width:100%">
        </div>

        <div class="my-slides fade">
            <div class="numbertext">9 / 10</div>
            <img src="../images/stillness.jpg" style="width:100%">
        </div>

        <div class="my-slides fade">
            <div class="numbertext">10 / 10</div>
            <img src="../images/studio.jpg" style="width:100%">
        </div>
